...
! Computes the commutator using two consecutive Matrix - Matrix multiplucation with CUBLAS_DGEMM
...
! Release resurces from the device
      if (stat.NE.0) then
...
! Computes the commutator using two consecutive Matrix - Matrix multiplucation with CUBLAS_ZGEMM
...
! Release resources from the device
      call CUBLAS_FREE ( devPtrA )
      call CUBLAS_FREE ( devPtrB )
      call CUBLAS_FREE ( devPtrC )
      DEALLOCATE(scratch)
